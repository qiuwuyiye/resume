...
\datedsubsection{\faCheck\ {\textbf{图形化大数据机器学习平台 BDA Studio}}}{2015年8月 -- 至今}
%\role{团队项目}{Developer, Spark}
\textbf{个人职责}\ \ 算法工程师\newline
\begin{onehalfspacing}
\textbf{项目概述}\ \ 图形化机器学习平台由BDA Studio以及BDALib 构成，分别是大数据机器学习库和可拖拽大数据机器学习平台 \href{http://bda.space:18080}{BDA Studio}.
\begin{itemize}
